...
class MethodParamsParser {
  List<Arg> parseParams(Operation operation) {
    //TODO:
    return [];
  }
}
...
class Arg {
  // TODO: should explain everything about a single parameter of an api method like its type, name & is it optional or not
}
