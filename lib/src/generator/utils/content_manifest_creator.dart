...
class ContentManifestCreator {
  ...
  ContentManifest? generateContentType({
    ...
    bool generateGetBodyMethod = false,
  }) {
    ...
    return ContentManifest(
      ...
      extensionMethods: createExtensions(
          className, _mapOfDataElements, generateGetBodyMethod),
  ...
  String createExtensions(
    ...
    buffer.writeln('\n');
    buffer
        .writeln('extension ${parentClassName}Extensions on $parentClassName{');
    ...
    for (var entry in content.entries) {
      ...
      if (contentType == 'application/json') {
        buffer.writeln('$parentClassName fromJson(dynamic json) {');
    ...
    if (generateGetBodyMethod) {
      buffer.writeln('dynamic get body {');
      buffer.writeln("return  '';");
      buffer.writeln('}');
    }
